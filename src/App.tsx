          ...
          <div className="flex items-center justify-between px-4 py-5 border-b border-border">
            {!sidebarCollapsed ? (
              <button onClick={handleBack} className="flex items-center gap-2.5 hover:opacity-75 transition-opacity" title="Dashboard">
                <LogoMark />
                <div>
                  <p className="font-display font-bold text-sm tracking-widest text-accent uppercase">UNRLVL</p>
      ...
      <div className="text-center animate-fade-in relative z-10">
        <div className="flex items-center justify-center gap-3 mb-6">
          ...
          <h1 className="font-display font-bold text-4xl tracking-tight">
            <span className="text-accent">UNRLVL</span><span className="text-muted"> ·</span><span className="text-text"> Brand Onboarding</span>
          </h1>
        </div>
...
function LogoMark({ size = 28 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 28 28" fill="none">
      ...
      <path d="M6 8l4 12M6 8l8 6M18 8l4 12M18 8l-4 6" stroke="#00FFD1" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
